export const translations = {
  en: {
    ...
    home: {
      ...
      followYouTube: 'Subscribe on YouTube',
    ...
    contact: {
      ...
      facebook: 'Facebook',
      facebookText: 'Like our page for news and updates',
      youtube: 'YouTube',
      youtubeText: 'Watch our videos and health content',
      linktree: 'Linktree',
    ...
    doctors: {
      ...
      // Dr. Rajitha Kata
      drRajithaKataName: 'Dr. Rajitha Kata',
      drRajithaKataSpecialty: 'General Physician and Diabetologist',
      drRajithaKataBio: 'General physician and diabetologist with expertise in primary care, chronic disease management, and diabetes care.',
      drRajithaKataEducation: 'MBBS, MD General Medicine',
      drRajithaKataSpec1: 'General Medicine',
      drRajithaKataSpec2: 'Diabetes Care',
      // Dr. Surendra
  ...
  te: {
    ...
    home: {
      ...
      followYouTube: 'యూట్యూబ్‌లో సబ్‌స్క్రైబ్ చేయండి',
    ...
    contact: {
      ...
      facebook: 'ఫేస్‌బుక్',
      facebookText: 'వార్తలు మరియు నవీకరణల కోసం మా పేజీని లైక్ చేయండి',
      youtube: 'యూట్యూబ్',
      youtubeText: 'మా వీడియోలు మరియు ఆరోగ్య కంటెంట్‌ను చూడండి',
      linktree: 'లింక్‌ట్రీ',
    ...
    doctors: {
      ...
      // డా. రజిత కాటా
      drRajithaKataName: 'డా. రజిత కాటా',
      drRajithaKataSpecialty: 'సాధారణ వైద్యుడు మరియు మధుమేహ నిపుణుడు',
      drRajithaKataBio: 'ప్రాథమిక సంరక్షణ, దీర్ఘకాలిక వ్యాధి నిర్వహణ మరియు మధుమేహ సంరక్షణలో నైపుణ్యం కలిగిన సాధారణ వైద్యుడు మరియు మధుమేహ నిపుణుడు.',
      drRajithaKataEducation: 'MBBS, MD General Medicine',
      drRajithaKataSpec1: 'సాధారణ వైద్యం',
      drRajithaKataSpec2: 'మధుమేహ సంరక్షణ',
      // డా. సురేంద్ర
