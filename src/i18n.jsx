export const translations = {
  en: {
    ...
    home: {
      tagline: '<strong>First super speciality</strong> hospital in Kavali. Providing compassionate, quality healthcare to our community for over <strong>25 years</strong>.',
    ...
    about: {
      title: 'About Us',
      intro1: 'Dr. Ramaswamy Hospitals is <strong>Kavali\'s first super-speciality hospital</strong>, founded by Kavali\'s <strong>first Orthopaedic Surgeon</strong> with over <strong>50,000 successful surgeries</strong>. With 25+ years of trusted service, we\'ve introduced many healthcare firsts — from advanced ICUs and dialysis care to 24/7 medical support. Guided by strong ethics and compassion, we continue our mission to provide <strong>quality, affordable, and patient-focused care</strong> to every individual who walks through our doors.',
      intro2: '',
      mission: 'Our Mission',
      missionText: 'At Dr. Ramaswamy Hospitals, our motto is <strong>"To care and to cure."</strong> We are committed to providing <strong>high-quality, affordable healthcare</strong> for everyone. Our focus is on delivering <strong>advanced medical care with compassion</strong>, ensuring safety, comfort, and excellence. We value every patient\'s trust and feedback as we continue to improve our services. With <strong>ethics and empathy</strong> at our core, we strive to be the most trusted healthcare partner for families in Kavali and beyond.',
      vision: 'Vision',
      visionText: 'To be the <strong>leading healthcare provider</strong> in the region, recognized for <strong>exceptional medical care, compassionate service</strong>, and our commitment to <strong>improving community health</strong> through quality treatment and health awareness initiatives.',
      motto: 'Motto',
      mottoText: 'Our hospital\'s motto is <strong>"Care and Cure."</strong> We are dedicated to providing <strong>high-quality healthcare</strong> to every patient, offering <strong>compassionate support</strong> to those in need, and continuously improving our services based on patient feedback.',
    ...
    services: {
      ...
      generalMedicineDesc: 'General Medicine department, we are equipped with ECG, ECHO, equibilator, inotropic syringe pumps, ventilators, succession tubes, with all ICU facilities to cure emergencies, our present physician in good at handling Cardiac, cerebral cases, all pulmonary cases, all types of fevers and chronic diseases like diabeties, hypertension and thyroid – Dr. Pushpika',
    ...
    doctors: {
      ...
      drRamaswamySpecialty: 'M.B., B.S., M.S., M.Ch. (Ortho)',
      drRamaswamyBio: 'Kavali\'s very first Orthopaedic Surgeon with over 50,000 successful surgeries. Founder & CEO of Dr. Ramaswamy Hospitals, dedicated to restoring mobility and transforming lives.',
  ...
  te: {
    ...
    home: {
      tagline: 'కావలిలో <strong>మొదటి సూపర్ స్పెషాలిటీ</strong> హాస్పిటల్. <strong>25 సంవత్సరాలకు</strong> పైగా మా సమాజానికి దయతో కూడిన, నాణ్యమైన ఆరోగ్య సంరక్షణ అందిస్తున్నాము.',
