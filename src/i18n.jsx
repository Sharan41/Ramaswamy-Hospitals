export const translations = {
  en: {
    ...
    doctors: {
      ...
      callNow: 'Call Now',
      hiringTitle: 'Join Our Team',
      hiringText: 'We are currently hiring experienced General Surgeon and Urologist. If you are interested in joining our dedicated medical team, please send your resume or call us for more details.',
  ...
  te: {
    ...
    doctors: {
      ...
      callNow: 'ఇప్పుడే కాల్ చేయండి',
      hiringTitle: 'మా టీమ్‌లో చేరండి',
      hiringText: 'మేము ప్రస్తుతం అనుభవజ్ఞులైన జనరల్ సర్జన్ మరియు యూరాలజిస్ట్‌ను నియమించుకుంటున్నాము. మా అంకితమైన వైద్య బృందంలో చేరడానికి మీకు ఆసక్తి ఉంటే, దయచేసి మీ రెజ్యూమ్‌ను పంపండి లేదా మరిన్ని వివరాల కోసం మమ్మల్ని సంప్రదించండి.',
